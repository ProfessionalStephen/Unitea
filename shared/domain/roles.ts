...
export const RT: Record<string, RoleConfig> = {
  ...
  "Office Administrator": { color: COLOR.blue, boards: ["New Sale Board", "Funding"], region: "Both", nested: false, kpis: ["Funding pipeline value", "M1 invoices needed", "Missing NTP count", "Cancellations this week"], sendFreq: "daily" },
  "Installation Manager": { color: COLOR.blue, boards: ["Customer Service", "New Sale Board", "Scheduling/Coordinating", "R&R "], region: "FL", nested: false, kpis: ["Installs scheduled today", "Installs completed yesterday", "Material ordered pending", "Install not completed", "HOA approvals pending", "R&R jobs active"], sendFreq: "daily" },
  ...
  "Permitting Coordinator": { color: COLOR.blue, boards: ["Permitting"], region: "FL", nested: false, kpis: ["Permits to submit today", "Permits submitted this week", "Permit application setbacks", "Permits in revision", "Awaiting approval", "Overdue permits"], sendFreq: "daily" },
  ...
  "Inspection Coordinator": { color: COLOR.blue, boards: ["Inspection"], region: "FL", nested: false, kpis: ["Inspections to schedule", "Inspections scheduled today", "Inspection Red-Tags", "Passed inspections", "Pending COC", "Affidavits needed"], sendFreq: "daily" },
  ...
  "Sales Relations Manager": { color: COLOR.blue, boards: ["New Sale Board", "Cancellations"], region: "Both", nested: false, kpis: ["Pipeline deals active", "Cancellations this week"], sendFreq: "daily" },
  ...
  "Onboarding Coordinator": { color: COLOR.blue, boards: ["New Sale Board"], region: "Both", nested: false, kpis: ["New deals this week", "Site surveys scheduled", "Site surveys to schedule", "Missing NTP count"], sendFreq: "daily" },
