...
export const RT: Record<string, RoleConfig> = {
  ...
  "Office Administrator": { color: COLOR.blue, boards: ["New Sale", "Funding"], region: "Both", nested: false, kpis: ["Funding pipeline value", "M1 invoices needed", "Missing NTP count", "Cancellations this week"], sendFreq: "daily" },
  ...
  "Receptionist": { color: COLOR.blue, boards: ["Customer Service", "New Sale"], region: "FL", nested: false, kpis: ["Welcome calls pending", "Site capture pending"], sendFreq: "daily" },
  ...
  "Sales Relations Manager": { color: COLOR.blue, boards: ["New Sale", "Cancellations"], region: "Both", nested: false, kpis: ["Pipeline deals active", "Cancellations this week"], sendFreq: "daily" },
  // Account Manager: dropped "Enerflo sync issues" and "NOC filings pending".
  "Account Manager": { color: COLOR.blue, boards: ["New Sale", "Customer Service", "Permitting"], region: "Both", nested: false, kpis: ["Welcome calls due", "Site surveys to schedule", "Permit submitted calls due"], sendFreq: "daily" },
  // After Hours AM: dropped "After hours calls received", "Inbound calls today".
  "After Hours Account Manager": { color: COLOR.blue, boards: ["New Sale", "Customer Service"], region: "Both", nested: false, kpis: ["Site surveys scheduled", "Welcome calls completed"], sendFreq: "daily" },
  // Onboarding Coordinator: original KPIs were all HR. Substituted w/ New Sale board equivalents.
  "Onboarding Coordinator": { color: COLOR.blue, boards: ["New Sale"], region: "Both", nested: false, kpis: ["New deals this week", "Site surveys scheduled", "Site surveys to schedule", "Missing NTP count"], sendFreq: "daily" },
  ...
  "Funding Coordinator": { color: COLOR.blue, boards: ["Funding", "Completed Meter"], region: "Both", nested: false, kpis: ["PTOs to audit today", "NTP tracking active", "M1 invoices needed", "M2 invoices needed", "M3 invoices needed"], sendFreq: "daily" },
